...
<html>
        ...
        <div class="container">
            <div class="row text-center">
              <div class="col-md-12">
                ...
                <button class="btn btn-danger trigger_btns" id="trigger_btn">Drop Button</button>
              </div>  
            </div>
        </div>
        <br>
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">
                                <h3 class="panel-title">
                                    <a href="#section" id="section_anchor" data-toggle="collapse" data-parent="#section">Controls</a>
                                </h3>
                            </div>
                                    ...
                                    <div class="tab-pane" id="multiple">
                                        ...
                                        <div class="elemField btn_click selectorField draggableField">
                                        	<div class="ctrl-button">
	                                        	<label class="radio-inline">
	                                        		<a class="btn btn-default" type="button" target="_blank">Docs</a>
	                                        	</label>
	                                        </div>	
                                        </div>                                         
                                    </div>               	    
	...
	<script id="button-template" type="text/x-handlebars-template">
		<p><label class="control-section">Label</label><input class="form-control" type="text" name="button_label" placeholder="Docs" style="width: 50%"></input></p> 
		...
		<p><label class="control-label">File</label>
			<select class="form-control" style="width: 50%" name="url_link">
				<option value=""></option>
				<option value="dl/coreo/CoreoRouter.pdf">Coreo</option>
				<option value="dl/cnckits.7z">CNC Kits</option>
		    </select>
		</p>
	</script>
	...
	<script>
	  ...
	  /* Specific method to load values from a section control to the customization modal */
		...
		load_values.radiogroup = function(ctrl_type, ctrl_id) {
	    	...
	    	model[div_ctrl.parent().parent().parent().prop('id')].sections
	    	// $('#radio_required').prop('checked', model[div_ctrl.parent().parent().parent().prop('id').sections.ctrl_id].required_field);
	...
	/* Specific method to save Options and their corresponding Part Numbers */
		...
		save_changes.button = function(values) {
			...
			div_ctrl.find('a').attr('href', values.url_link);
		}
		...
		*/ 
		...
		var _ctrl_index = 3001;
	  	...
	  	$('#retrieve').click(function() {
	  		...
	  		if ($('a#section_anchor').hasClass('collapsed')) {
	  			$('#section_anchor').click();
	  		}
		...
		function preview() {
		  ...
		  dialogContent+= '$(\'input[type="radio"]\').click(function(e){\
                     ...
                     \n   infoModal.find(".modal-body").html(JSON.stringify(values, true, 3));\
	...
	<script type="text/javascript" src="/js/latest_js.js"></script>
	</body>
</html>
